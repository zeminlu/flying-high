...
#define KEY_F1      KB_KEY_RELEASE | 1
#define KEY_F2      KB_KEY_RELEASE | 2 
#define KEY_F3      KB_KEY_RELEASE | 3 
#define KEY_F4      KB_KEY_RELEASE | 4 
#define KEY_F5      KB_KEY_RELEASE | 5 
#define KEY_F6      KB_KEY_RELEASE | 6
#define KEY_F7      KB_KEY_RELEASE | 7
#define KEY_F8      KB_KEY_RELEASE | 8
