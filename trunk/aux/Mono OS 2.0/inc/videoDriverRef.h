...
void turnOnMouse( char mouseFormat );
...
void changeMouseFormat( char mouseFormat );
...
size_t bufferizeScreen( int lX, int uX, int lY, int uY, char * buffer );
...
int screenColorArea( int lX, int uX, int lY, int uY, char format );
